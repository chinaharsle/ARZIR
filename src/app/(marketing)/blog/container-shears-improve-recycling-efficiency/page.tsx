...
import { ArrowRight, Clock, User, Calendar, ChevronLeft, ChevronRight, CheckCircle, TrendingUp, Zap, Timer, Truck, BarChart3, DollarSign } from "lucide-react";
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "/images/blog/How Container Shears Improve Scrap Metal Recycling Efficiency.webp",
        width: 1200,
        height: 630,
      ...
      <Section size="lg" className="relative overflow-hidden bg-gradient-to-br from-arzir-gray-50 to-white">
        <div className="max-w-4xl mx-auto text-center space-y-6">
          ...
          <div className="aspect-[16/9] bg-gradient-to-br from-arzir-gray-100 to-arzir-gray-200 rounded-2xl overflow-hidden shadow-lg max-w-4xl mx-auto relative">
            <Image 
              src="/images/blog/How Container Shears Improve Scrap Metal Recycling Efficiency.webp" 
