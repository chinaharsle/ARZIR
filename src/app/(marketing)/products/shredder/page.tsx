      ...
      <Section background="gray" size="lg">
        <div className="bg-white rounded-3xl p-8 lg:p-12 text-center space-y-6">
          <h2 className="text-2xl lg:text-3xl font-heading font-bold text-black">
            Need help selecting the right shredder?
          </h2>
          <p className="text-arzir-gray-600 max-w-2xl mx-auto">
            Our engineers can help you choose the optimal shredder configuration based on your material types, throughput requirements, and output specifications.
          </p>
          <QuoteDialog source="shredder_bottom">
            <Button size="lg" className="bg-arzir-primary hover:bg-primary-600">
              Get Expert Help
              <ArrowRight className="ml-2 h-5 w-5" />
            </Button>
