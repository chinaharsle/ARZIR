      ...
      <Section background="white" size="lg">
        <div className="bg-arzir-gray-50 rounded-3xl p-8 lg:p-12 text-center space-y-6">
          <h2 className="text-2xl lg:text-3xl font-heading font-bold text-black">
            Need rapid brittle material processing?
          </h2>
          <p className="text-arzir-gray-600 max-w-2xl mx-auto">
            Our engineers can help you configure the optimal hammer shredder for your brittle material processing requirements and throughput goals.
          </p>
          <QuoteDialog source="hammer_shredder_bottom">
            <Button size="lg" className="bg-arzir-primary hover:bg-primary-600">
              Get Rapid Processing Solution
              <ArrowRight className="ml-2 h-5 w-5" />
            </Button>
          </QuoteDialog>
        </div>
